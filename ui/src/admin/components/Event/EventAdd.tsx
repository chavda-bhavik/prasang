...
const EventAdd = (props:any) => {
    ...
    const onDataChange = (e:any,name:string,image:string) => {
        ...
        else if(name == 'startDate' || name == 'lastRegistraionDate')
        {
            ...
            {
                if(e!=null){
                    oldData['lastRegistraionDate'] = moment(e._d).format('DD-MM-YYYY');
                }
                else
                {
            ...
            <Card title="Event Form" bordered={false} >
                <Form name="basic" onFinishFailed={onFinishFailed} labelCol={{ span: 3 }} wrapperCol={{ span: 14 }} >
                    <Form.Item label="Title"
                      ...
                      >
                        <Input name="title" onChange={(e) => onDataChange(e,'title','')}/>
                    </Form.Item>
                    ...
                    >
                        <Select {...nameAttr} placeholder="Please select a category" onChange={(e) => onDataChange(e,'categoryId','')}>
                            {(props.category) ? fetchCategory(props.category) : null }
                        </Select>
                    </Form.Item>
                    ...
                    <Form.Item label="Fees"
                      ...
                      >
                        <Input name="fees" placeholder={"10"} value={event.fees} onChange={(e) => onDataChange(e,'fees','')}/>
                    </Form.Item>
                    <Form.Item label="Description"
                      ...
                      >
                        <Input name="description" onChange={(e) => onDataChange(e,'description','')}/>
                    </Form.Item>
                    <Form.Item
                        label="Event Image" 
